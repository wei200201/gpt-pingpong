...
@router.get('/users', response_class=HTMLResponse, response_model=list[UserOut])
...
@router.get('/load_form', response_class=HTMLResponse, response_model=UserOut)
def read_users(request: Request):
    return templates.TemplateResponse('add_user.html', {'request': request})

@router.get("/users2/", response_model=List[UserOut])
